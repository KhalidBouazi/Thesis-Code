% Usage: pgfplot(x,y,[name], [x2,y2,[name]...], filename, folder)
%
% Die Funktionsweise von "pgfplot(.)" ist (fast) die gleiche, wie die von 
% der Matlab-Funktion "plot(x,y)".
% 
...
%
% 'x' und 'y' können Vektoren oder Matrizen sein. Die Angabe von 'name' ist
% optional.
% 
% Die Datei "pgfplot(.)" kann bedenkenlos mehrmals ausgeführt werden, ohne
...
%   y2 = cos(x);
%   
%   pgfplot(x,y1,'myfile.tikz','d:\myfolder');
%   pgfplot(x,y1,'Sinus',x,y2,'Cosinus','myfile.tikz','d:\myfolder');
%   pgfplot(x,[y1;y2],'SinusCosinus','myfile.tikz','d:\myfolder');
%   ...
function [] = pgfdisceigplot_(varargin)
...
if ~exist(strcat(folder,filename,fileext),'file')
    cvec = {'red';'blue';'green';'black';'violet';'cyan';'magenta';'gray';'orange';'gray';'olive';'purple';'teal';'red';'blue';'green';'black';'violet';'cyan';'magenta';'gray';'orange';'gray';'olive';'purple';'teal';'red';'blue';'green';'black';'violet';'cyan';'magenta';'gray';'orange';'gray';'olive';'purple';'teal';'red';'blue';'green';'black';'violet';'cyan';'magenta';'gray';'orange';'gray';'olive';'purple';'teal';'red';'blue';'green';'black';'violet';'cyan';'magenta';'gray';'orange';'gray';'olive';'purple';'teal';'red';'blue';'green';'black';'violet';'cyan';'magenta';'gray';'orange';'gray';'olive';'purple';'teal';'red';'blue';'green';'black';'violet';'cyan';'magenta';'gray';'orange';'gray';'olive';'purple';'teal';'red';'blue';'green';'black';'violet';'cyan';'magenta';'gray';'orange';'gray';'olive';'purple';'teal';'red';'blue';'green';'black';'violet';'cyan';'magenta';'gray';'orange';'gray';'olive';'purple';'teal'};
    ...
    fprintf(fid,'  \\begin{axis}[xlabel=Re($\lambda$), \r\n');
    fprintf(fid,'               ylabel=Im($\lambda$), \r\n');
    ...
    for i=1:numprintlines
      if set(i) == 1
        fprintf(fid,'    \\addplot[only marks, mark=x, mark options={solid}, %s, semithick] table{%s};\r\n',cvec{i},strcat(path,linenames{i},'.txt'));
      else
        fprintf(fid,'    \\addplot[only marks, mark=x, mark options={solid}, %s, semithick] table{%s};\r\n',cvec{i},strcat(path,linenames{i},'-',num2str(1),'.txt'));
        for j=2:set(i)
          fprintf(fid,'    \\addplot[only marks, mark=x, mark options={solid, fill=white, fill opacity=60}, %s, semithick, forget plot] table{%s};\r\n',cvec{i},strcat(path,linenames{i},'-',num2str(j),'.txt'));
        end
      end
      if numprintlines > 1
