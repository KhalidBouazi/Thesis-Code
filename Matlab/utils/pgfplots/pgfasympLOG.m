...
% plottet werden und die Ausgabe doppeltlogarithmisch erfolgt
%
...
% falls sich die Länge der Vektoren bzw. Matrizen x und y ändert.Dies muss 
...
%   G2 = zpk([],[-10],10);
%   
%   pgfasympLOG(G1,'myfile.tikz','d:\myfolder');
%   pgfasympLOG(G1,'a',G2,'b',{1e0,1e2},'myfile.tikz','d:\myfolder');
%   ...
function [] = pgfasympLOG(varargin)
...
if ~exist(strcat(folder,filename,fileext),'file')
    ...
    fprintf(fid,'  \\begin{bodeAmpLOG}[mark size = 0.8mm,        %% Radius der Marker\r\n');
