function [mag, phase, w, amag, amagw, aphase, aphasew] = asymp(sys,w)
% function [mag, phase, w, amag, amagw, aphase, aphasew] = asymp(sys,wlow,whigh)
...
% Rückgabevariablen für Amplitudengang
amag  = magpoints;
amagw = freqpoints;
