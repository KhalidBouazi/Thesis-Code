...
config.general.algorithms = struct('DMD',@DMD,'DMDc',@DMDc,'EDMD',@EDMD,'kDMD',@kDMD,...
    'HDMD',@HDMD,'HDMDc',@HDMDc,'BiHDMDc',@BiHDMDc,'HAVOK',@HAVOK,'HAVOKc',@HAVOKc,'CONVCOORD',@CONVCOORD);
...
config.dmd.fieldnames.svd = {'U_','s_','sn','sn_','V_'};
config.dmd.fieldnames.hankel = {'H'};
...
config.dmd.fieldnames.order = [config.dmd.fieldnames.input,config.general.fieldnames.data,...
    config.dmd.fieldnames.hankel,config.dmd.fieldnames.svd,config.dmd.fieldnames.model,...
...
config.dmdc.fieldnames.input = {'algorithm','system','params','x0','input',...
    'dt','timesteps','horizon','rank','delays','spacing','measured','observables'};
config.dmdc.fieldnames.svd = {'U_','s_','sn','sn_','V_'};
config.dmdc.fieldnames.data = {'U'};
config.dmdc.fieldnames.hankel = {'H','Hu'};
config.dmdc.fieldnames.model = {'Atilde','Btilde','W','d','Phi','omega','b','A','B',...
    'Ytrain','Yr','tr','RMSEYr','rmseYr','Ytest','Yp','tp','RMSEYp','rmseYp',...
    'RMSEY','rmseY'};

config.dmdc.fieldnames.order = [config.dmdc.fieldnames.input,config.general.fieldnames.data,...
    config.dmdc.fieldnames.data,config.dmdc.fieldnames.hankel,config.dmdc.fieldnames.svd,...
