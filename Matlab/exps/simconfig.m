...
config.general.algorithms = struct('DMD',@DMD,'DMDc',@DMDc,'HDMD',@HDMD,...
    'HDMDc',@HDMDc,'HAVOK',@HAVOK,'HAVOKc',@HAVOKc,'CONVCOORD',@CONVCOORD);
...
config.hdmdc.fieldnames.order = [config.havokc.fieldnames.input,config.general.fieldnames.data,...
    config.havokc.fieldnames.data,config.havokc.fieldnames.hankel,config.general.fieldnames.svd,...
