...
config.general.plots = ...
    struct('phaseY',struct('name','Phasenraum','fun',@phaseplot,'args',{{'X','x'}},'loc','main'),...
           'phaseV',struct('name','Delay Phasenraum','fun',@phaseplot,'args',{{'V','v'}},'loc','main'),...
           ...
           'sing',struct('name','Singulärwerte','fun',@singplot,'args',{{'sn'}},'loc','main'),...
           'phasebasisY',struct('name','Phasenraum mit SVD Moden','fun',@phasebasisplot,'args',{{'X','V'}},'loc','sec'),...
...
config.dmd.fieldnames.input = {'algorithm','system','params','x0',...
    'dt','timesteps','horizon','rank','delays','spacing','measured','observexp'};
